...
const AboutPage = () => (
  <div>
    ...
    <section className={styles.mainSection}>
      <span className={styles.textBlock}>
        <p>
          ...
          areas of developing nations, such as Ghana and Uganda. We develop a maternal health app
          for both the iOS and Android platforms which allows community health workers in rural
          regions to keep track of patients and ensure they get the proper prenatal and postnatal
          visits during their pregnancies.
        </p>
      </span>
      ...
      <span className={styles.right}>
        ...
        <p>
          ...
          Our mobile application provides software for CHWs to register pregnancies, facilitate
          prenatal and postnatal care, and educate providers on potential complications during and
          after pregnancy.
        </p>
        <br />
      ...
      <span className={styles.left}>
        ...
        <h2>Our Mission</h2>
        <p>
          Our mission is to improve access to prenatal and postnatal care through a mobile
          application.
        </p>
        <br />
      </span>
    ...
    <br />
    <div style={{ margin: '65px 0' }} className={styles.clear} />
    <br />
    <br />
